...
Allow users to re-run asynchronous evaluation for completed text and voice interview records while preserving the previous report until a new evaluation succeeds.
